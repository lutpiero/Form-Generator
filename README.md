...
| TC-003 | Boundary check - maximum allowed name length | Full Name: `123456789012345678901234567890`, Email: `max.name@example.com`, Phone: `082222222222`, Age: `45`, Address: `Jl. Kenanga 77` | Success: `Submission accepted with maximum name length (30 characters).` | - [ ] |

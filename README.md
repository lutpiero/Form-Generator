...
| TC-003 | Boundary check - maximum allowed name length | Full Name: `Christopher Maximilian Hartono`, Email: `max.name@example.com`, Phone: `082222222222`, Age: `45`, Address: `Jl. Kenanga 77` | Success: `Submission accepted with maximum name length (30 characters).` | - [ ] |
